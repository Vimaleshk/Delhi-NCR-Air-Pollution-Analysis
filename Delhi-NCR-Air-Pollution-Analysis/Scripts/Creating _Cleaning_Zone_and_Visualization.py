# ========================================================
# Alipur Air Quality: Cleaning & Visualization Script
# ========================================================
...
# 2️⃣ Load Dataset
file_path = r"E:\Welt Research\2022\Cleaned Data\cleaned_Ashok Vihar.csv" # <-- change if needed
...
# 5️⃣ AQI Calculation (simplified)
def calculate_aqi_pm25(pm25):
    ...
    elif pm25 <= 250: return 300 + (pm25-120)*200/130
...
def calculate_aqi_pm10(pm10):
    ...
    elif pm10 <= 430: return 300 + (pm10-350)*200/80
...
# 6️⃣ Outlier Detection & Cleaning
print("="*60)
print("OUTLIER ANALYSIS AND CLEANING")
print("="*60)

pollutant_cols = ['PM2.5', 'PM10', 'NO', 'NO2', 'NOx', 'NH3', 'SO2', 'CO', 'Ozone', 'AQI']
...
# Plot seasonal and monthly trends
